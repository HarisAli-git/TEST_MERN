...
import { Post_SignUpMongo } from "./RESTapi_caller";
                            ...
                            <div className="rightside">
                                ...
                                <div className="SignUpC">
                                    <form onSubmit={(event) => {
                                        ...
                                        Post_SignUpMongo({ name: this.state.name, price: this.state.price}).then(response => {
                                            console.log(response.data)
                                            this.setState({ Res: response.data });
                                        }).catch(error => { console.log(error) });
                                    }}>
                                        <input type="input" id="name" name="name" placeholder="Name of the Product" className="fnm" value={this.state.Name}
                                            onChange={(event) => { this.setState({ name: event.target.value }) }}></input><br></br><br></br>
                                        <input type="number" id="price" name="price" placeholder="Price of the Product" className="em" value={this.state.Email}
                                            onChange={(event) => { this.setState({ price: event.target.value }) }}></input><br></br><br></br>
